...
st.set_page_config(
    page_title="ADAM Student engagement system  ",
    page_icon='./images/lodoADAM.png',
)

html_string = """
<h1> Welcome to ADAM Student engagement system </h1>
"""
...
link_clicked = st.markdown("""
        <a href="http://127.0.0.1:8000/" target="_blank">View</a>
